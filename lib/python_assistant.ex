defmodule PythonAssistant do
  ...
  def start do
    ...
    IO.puts("Python. Escribe 'END' para enviar tu mensaje o 'exit' para salir.")
  ...
  defp create_assistant do
    %{"id" => id} = @openai |> Assistants.create(%{
      ...
      description: "You are a helpful Data Scientist working with Python",
      instructions: "You are a helpful Data Scientist working with Python",
  ...
  defp create_thread do
    %{"id" => id} = @openai |> Threads.create(%{
      instructions: "You are a helpful Data Scientist working with Python",
      name: "helpful Data Scientist working with Python",
      tools: [%{type: "code_interpreter"}],
      model: "gpt-4o"
    })
    id
